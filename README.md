...
You can simply download the `.craftx` file from the latest [Release](https://github.com/FlohGro-dev/Craftist/releases/tag/0.7.1) and add it to your eXtensions in Craft on macOS.
